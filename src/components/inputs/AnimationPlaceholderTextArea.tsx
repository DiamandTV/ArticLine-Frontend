...
export function AnimationPlaceholderTextArea(
        ...
        return (
            <div className="flex flex-col relative w-full">
                <label
                    className= {`select-none transition-all duration-100 ease-in-out absolute z-10 top-0 px-0 py-2 text-neutral-400 hover:cursor-pointer ${focus ? 'translate-y-[-80%] translate-x-2 text-sm ' : 'translate-y-0 translate-x-0 text-lg'}`} 
                    htmlFor={name}>
