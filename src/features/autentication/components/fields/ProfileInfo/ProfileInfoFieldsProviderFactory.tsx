...
import { ProfileFormMap } from "@features/autentication/models/Profile/InfoFields/ProfileInfoFields/ProfileInfoFieldsType";
import { ProfileType } from "@features/autentication/models/Profile/Interface/Type";

interface ProfileInfoFieldsProviderFactory<T extends ProfileType> extends GenericFieldsProviderProps<ProfileFormMap[T]>{
    profileType:ProfileType
}

export function ProfileInfoFieldsProviderFactory<T extends ProfileType>(props:ProfileInfoFieldsProviderFactory<T>){
    const ProfileInfoProvider = FieldsProvider<ProfileFormMap[T]>
    return (
